...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Load += gcnew System::EventHandler(this, &levelsForm::levelsForm_Load);
...
#pragma endregion
	private: System::Void level1_btn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		writeFile->WriteLine(user);      //3shan a save esm tefl abl record;
		writeFile->Close();
...
private: System::Void levelsForm_Load(System::Object^ sender, System::EventArgs^ e) {
}
};
}
